...
export const Cards = () => {
  return (
    <div className="py-10 bg-transparent">
      <section className="max-w-screen-xl w-full mx-auto grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
        {/* Card 1 */}
        <div className="flex flex-col items-center justify-between bg-white bg-opacity-80 rounded-lg p-4 sm:p-5 md:p-6 transition duration-300 hover:shadow-lg">
